...
// 61. CDC STAR-100 Project
lazy val cdcstar100 = (project in file("cdcstar100/rtl"))
  .dependsOn(common)
  .settings(
    name := "CdcStar100"
  )
...
// 62. TI ASC Project
lazy val tiasc = (project in file("tiasc/rtl"))
  .dependsOn(common)
  .settings(
    name := "TiAsc"
  )
...
// 63. Convex C1 Project
lazy val convexc1 = (project in file("convexc1/rtl"))
  .dependsOn(common)
  .settings(
    name := "ConvexC1"
  )
...
// 64. NEC SX-2 Project
lazy val necsx2 = (project in file("necsx2/rtl"))
  .dependsOn(common)
  .settings(
    name := "NecSx2"
  )
...
// 65. IBM System/370 Vector Facility Project
lazy val ibms370vf = (project in file("ibms370vf/rtl"))
  .dependsOn(common)
  .settings(
    name := "IbmS370Vf"
  )
...
// 66. IBM 801 Project
lazy val ibm801 = (project in file("ibm801/rtl"))
  .dependsOn(common)
  .settings(
    name := "Ibm801"
  )
...
// 67. SPARC Project
lazy val sparc = (project in file("sparc/rtl"))
  .dependsOn(common)
  .settings(
    name := "Sparc"
  )
...
// 68. PowerPC Project
lazy val powerpc = (project in file("powerpc/rtl"))
  .dependsOn(common)
  .settings(
    name := "Powerpc"
  )
...
// 69. JVM Project
lazy val jvm = (project in file("jvm/rtl"))
  .dependsOn(common)
  .settings(
    name := "Jvm"
  )
...
// 70. Setun Project
lazy val setun = (project in file("setun/rtl"))
  .dependsOn(common)
  .settings(
    name := "Setun"
  )
...
// 71. IBM 1620 Project
lazy val ibm1620 = (project in file("ibm1620/rtl"))
  .dependsOn(common)
  .settings(
    name := "Ibm1620"
  )
...
// 72. Symbolics 3600 Project
lazy val symbolics3600 = (project in file("symbolics3600/rtl"))
  .dependsOn(common)
  .settings(
    name := "Symbolics3600"
  )
...
// 73. MIT Tagged-Token Dataflow Project
lazy val mitdataflow = (project in file("mitdataflow/rtl"))
  .dependsOn(common)
  .settings(
    name := "MitDataflow"
  )
...
// 74. SUBLEQ Project
lazy val subleq = (project in file("subleq/rtl"))
  .dependsOn(common)
  .settings(
    name := "Subleq"
  )
...
// 75. SOAR Project
lazy val soar = (project in file("soar/rtl"))
  .dependsOn(common)
  .settings(
    name := "Soar"
  )
...
// 76. TTA Project
lazy val tta = (project in file("tta/rtl"))
  .dependsOn(common)
  .settings(
    name := "Tta"
  )
