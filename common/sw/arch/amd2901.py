...
class Amd2901Assembler(BaseAssembler, GeneralRegisterArchitecture, VariableLengthFormat, FixedPointOperations):
    word_width = 16
    address_width = 16
    num_gprs = 16
    num_fprs = 0
    ...
    def assemble_instruction(self, line):
        ...
        if mnemonic == "LD":
            ...
            raise Exception(f"Unknown AMD 2901 instruction: {line}")

    def format_output(self, values):
        out = []
        out.append("# Compiled AMD 2901 Hex File")
        for val in values:
