...
def assemble(input_text):
    ...
    output = ["# Compiled Goodyear MPP Hex File"]
    symbols = {}
    current_addr = 0
    ...
    for line in lines:
        ...
        if mnemonic in ["HALT", "HLT", "CLR_CARRY", "LD_PE_MASK"]:
            current_addr += 1
    ...
    for line in lines:
        ...
        if mnemonic == "LD_PE_BIT":
            ...
            raise Exception(f"Unknown Goodyear MPP mnemonic: {mnemonic}")
