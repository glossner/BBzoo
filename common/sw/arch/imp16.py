...
class Imp16Assembler(BaseAssembler, GeneralRegisterArchitecture, VariableLengthFormat, FixedPointOperations):
    word_width = 16
    address_width = 16
    num_gprs = 4
    num_fprs = 0
    ...
    def assemble_instruction(self, line):
        ...
        if mnemonic == "LD":
            ...
            raise Exception(f"Unknown IMP-16 instruction: {line}")

    def format_output(self, values):
        out = []
        out.append("# Compiled IMP-16 Hex File")
        for val in values:
