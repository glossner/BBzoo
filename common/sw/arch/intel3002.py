...
class Intel3002Assembler(BaseAssembler, GeneralRegisterArchitecture, VariableLengthFormat, FixedPointOperations):
    word_width = 16
    address_width = 16
    num_gprs = 12
    num_fprs = 0
    ...
    def assemble_instruction(self, line):
        ...
        if mnemonic == "LD":
            ...
            raise Exception(f"Unknown Intel 3002 instruction: {line}")

    def format_output(self, values):
        out = []
        out.append("# Compiled Intel 3002 Hex File")
        for val in values:
