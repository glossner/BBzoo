...
class JvmAssembler(BaseAssembler, StackArchitecture, VariableLengthFormat, FixedPointOperations):
    word_width = 32
    address_width = 32
    stack_depth = 16
    op_code_width = 8
    ...
    def assemble_instruction(self, line):
        ...
        if mnemonic == "ILOAD":
            ...
            raise Exception(f"Unknown JVM instruction: {line}")

    def format_output(self, values):
        out = []
        out.append("# Compiled JVM Hex File")
        for val in values:
