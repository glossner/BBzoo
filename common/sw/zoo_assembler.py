...
def main():
    ...
    parser.add_argument('-arch', required=True, choices=['pdp8', 'ibm360', 'cray1', 'm68k', 'burroughsb5500', 'decpdp11', 'cdc6600', 'mos6502', 'babbage', 'harvardmark1', 'zusez1', 'manchester', 'univac1', 'ias', 'edsac', 'ibm701', 'ibm704', 'ibm650', 'ibm705', 'ibm1401', 'stczebra', 'bullgamma60', 'ibmstretch', 'univac1103a', 'cdc6600ppu', 'decvax', 'intel8080a', 'motorola6800', 'ibm6150', 'mipsi', 'arm1', 'berkrisc', 'hp3000', 'lilith', 'ucsdp', 'upd7720', 'tms32010', 'adsp2100', 'mwave'], help='Target architecture')
