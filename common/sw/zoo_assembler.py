...
def main():
    ...
    parser.add_argument('-arch', required=True, choices=['pdp8', 'ibm360', 'cray1', 'm68k', 'burroughsb5500', 'decpdp11', 'cdc6600', 'mos6502', 'babbage', 'harvardmark1', 'zusez1', 'manchester', 'univac1'], help='Target architecture')
