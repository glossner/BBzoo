...
class CoreSpec extends AnyFlatSpec with Matchers {
  behavior of "DecvaxCore"

  it should "execute MOVL, ADDL2 instructions correctly to perform vector addition" in {
    ...
    val hexFile = findWorkspaceFile("decvax/sw/test_vector.hex")
