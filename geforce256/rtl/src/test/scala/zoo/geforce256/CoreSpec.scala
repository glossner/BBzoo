...
class CoreSpec extends AnyFlatSpec with Matchers {
  behavior of "Geforce256Core"

  it should "execute LD, ST, COMBINE, HALT instructions correctly to perform vector addition" in {
    ...
    val hexFile = findWorkspaceFile("geforce256/sw/test_vector.hex")
