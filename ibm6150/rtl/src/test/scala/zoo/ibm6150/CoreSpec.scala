...
class CoreSpec extends AnyFlatSpec with Matchers {
  behavior of "Ibm6150Core"

  it should "execute L, ST, A, HALT instructions correctly to perform vector addition" in {
    ...
    val hexFile = findWorkspaceFile("ibm6150/sw/test_vector.hex")
