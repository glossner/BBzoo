...
class CoreSpec extends AnyFlatSpec with Matchers {
  behavior of "Intel8080aCore"

  it should "execute LDA, STA, MOV, ADD, HLT instructions correctly on 8-bit values" in {
    ...
    val hexFile = findWorkspaceFile("intel8080a/sw/test_vector.hex")
