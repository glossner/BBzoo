...
class CoreSpec extends AnyFlatSpec with Matchers {
  behavior of "Mali200Core"

  it should "execute VLD, VST, VADD, HALT instructions correctly to perform vector addition" in {
    ...
    val hexFile = findWorkspaceFile("mali200/sw/test_vector.hex")
