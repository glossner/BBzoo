...
/**
 * Setun Core Processor.
 * A 32-bit stack-based core with stack memory.
 */
class SetunCore extends Module {
  ...
  // Sub-modules
  val decoder = Module(new SetunDecoder)
