...
class CoreSpec extends AnyFlatSpec with Matchers {
  behavior of "Univac1103aCore"

  it should "execute TP, ADD, SUB, and HLT correctly using two-address logic" in {
    ...
    val hexFile = findWorkspaceFile("univac1103a/sw/test_vector.hex")
